...
* Introduction to AngularJS (40-160 Hours) Refactor your Bolc Jams application with AngularJS
  * Introduction
  * Configuration
  * Routing and States
  * Templates
...
* Bloctime
  * Description: A time-management system based on the Pomdoro technique using AngularJS and Firebase
  * Intro
...
* Bolc Chat
  * Description: A real-time client using AngularJS and Firebase
  * Intro
  * List Chat Rooms
  * Create Chat Rooms
  * List Message
...
* Blocitoff
  * Description: A self-destructing to-do list application built with AngularJS and Firebase
  * Intro
  * Configure Firebase
  * View Active Tasks
  * Hide Old Tasks
...
* Bolcmetrics
  * Description: An analytics service and reporting tool for Bloc James using the D3.js visualization library
  * Intro
  * Capture Events
  * Display Events
  * Extra Credit

* Bloc Pong (40-160 Hours)
  * Description: The classic game Pong, built using javascript and the HTML5 canvas element.
  * Intro
  * Create Visuals
  * Control the Paddle
  * Animate the Ball
...
* Capstone Project (40-160 Hours)
  * Description: A new application of your choice that encourages you to invent. use new technilogies, think critically, and challenging problems.
  * Introduction
...
* Portfolio
  Description: A personal portfolio and blog to showcase your projects
  * Introduction
