...
Author: Jedi Chou, Create at 2021.6.18 8:23 AM

* Read Sina Blog. **8:24**
* Download books from salttiger (none). **8:25**
* Check gitee messages. **8:31**
* Update and upgrade packages at wsl. **8:35**
* Download ebook from jb51.net. **8:38**
* Read mails from skyzhx@163.com. **8:39**
* Read mails from 13417xx51@139.com. **8:44**
* Don't memorize words APP check-in. **8:48**
* 163 music APP check-in. **8:48**
* NowCoder check-in. **8:49**
...
* Check github messages. **12:00**
* Reading mail from jedigit@163.com mail. **14:00*
* 101WeiQi daily exercise check-in. **14:02**, **14:03**
* 百词斩. **14:06**, **14:11**
* Exercise of Vocabulary (vocabulary.com). **14:44**
* Go Game check
  * Leela Zero vs Leela Zero(B5s-W3s). **14:27**
  * Leela Zero vs Leela Zero(B5s-W3s). **14.44**
  * Leela Zero vs Leela Zero(B5s-W3s). **15:04**
