...
* [2021了，用PyTorch还是TensorFlow？](https://www.bilibili.com/video/BV1Uf4y147Bq)
* [离线强化学习简介 by Sergey Levine](https://www.bilibili.com/video/BV1xy4y187YL)
...
* Powershell terminal skill
  * 🙏 **crtl + l** to clean screen at powershell console. 11:19
  * 🙏 **crtl + a** will select your input. 11:21
  * 🙏 **ctrl + h** like press backspace. 11:24
  * 🙏 **ctrl + j** 可使得命令換行，但具體用途未知. 11:27
  * 🙏 **ctrl + <** 会调出配置文件，用户可进行配置. 11:28
  * 🙏 **ctrl + +/-** 在windows terminal中放大或缩小字体. 11:30
