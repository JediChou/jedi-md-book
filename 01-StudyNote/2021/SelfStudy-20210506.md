...
Author: Jedi Chou, Create at 2021.5.6 8:03 AM
...
* Daily study
  ...
  * Check gitee messages. **8:38**
  * Read Sina Blog. **9:08**
  * Check github messages. **8:58**
  * 101WeiQi daily exercise check-in. **11:50**, **17:23**
  * Exercise of Vocabulary (vocabulary.com). **15:56**
  * 百词斩

* Weekly task
  * reading mails from skyzhx@163.com. **8:40**
  * reading mail from jedigit@163.com mails. **11:49**
  * Reading 1 minutes at SIMPLE wiki or Baike.Baidu
  * Go Game check
    * Leela Zero vs Leela Zero(B5s-W3s) **8:34** (94%-90%)
    * Leela Zero vs Leela Zero(B5s-W3s) **8:58** (90%-82%)
    * Leela Zero vs Leela Zero(B5s-W3s) **9:11** (82%-77%)
    * Leela Zero vs Leela Zero(B5s-W3s) **10:23** (74%-71%)
    * Leela Zero vs Leela Zero(B5s-W3s) **10:37** (70%-65%)
    * Leela Zero vs Leela Zero(B5s-W3s) **10:54** (65%-59%)
    * Leela Zero vs Leela Zero(B5s-W3s) **11:10** (59%-52%)
    * Leela Zero vs Leela Zero(B5s-W3s) **11:29** (52%-49%)
    * Leela Zero vs Leela Zero(B5s-W3s) **11:39** (49%-45%)
    * Leela Zero vs Leela Zero(B5s-W3s) **11:55** (45%-38%)
    * Leela Zero vs Leela Zero(B5s-W3s) **13:48** (86%-81%)
    * Leela Zero vs Leela Zero(B5s-W3s) **14:06** (81%-75%)
    * Leela Zero vs Leela Zero(B5s-W3s) **14:29** (75%-68%)
    * Leela Zero vs Leela Zero(B5s-W3s) **15:13** (68%-62%)
    * Leela Zero vs Leela Zero(B5s-W3s) **15:29** (62%-54%)
    * Leela Zero vs Leela Zero(B5s-W3s) **15:44** (54%-48%)
    * Leela Zero vs Leela Zero(B5s-W3s) **16:00** (48%-41%)
    * Leela Zero vs Leela Zero(B5s-W3s) **16:15** (41%-36%)
    * Leela Zero vs Leela Zero(B5s-W3s) **17:23** (36%-26%)
    * Leela Zero vs Leela Zero(B5s-W3s) **17:35** (26%-19%)
    * Leela Zero vs Leela Zero(B5s-W3s) **17:50** (19%-13%)

* Download books from salttiger. **10:30**
