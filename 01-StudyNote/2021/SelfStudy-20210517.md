...
Author: Jedi Chou, Create at 2021.5.17 7:47 AM

* Download books from salttiger. **7:48**
* reading mails from skyzhx@163.com. **7:49**
* Check github messages. **8:12**
* Check gitee messages. **8:17**
...
* Read Sina Blog. **8:37**
* reading mail from jedigit@163.com mails. **10:06**
* Exercise of Vocabulary (vocabulary.com). **10:54**
* Reading 1 minutes at SIMPLE wiki or Baike.Baidu. **11:06**
* Download ebook from jb51.net(request refuuse). **11:07**
* vscode plugins: css-helper-plugin. **11:08**
* Go Game check
  * Leela Zero vs Leela Zero(B5s-W3s) **7:57** (87%-80%)
  * Leela Zero vs Leela Zero(B5s-W3s) **9:27** (80%-71%)
  * Leela Zero vs Leela Zero(B5s-W3s) **9:41** (71%-66%)
