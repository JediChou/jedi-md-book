...
Author: Jedi Chou, Create at 2021.5.26 8:04 AM

* Go Game check
  * Leela Zero vs Leela Zero(B5s-W3s) **8:02** (97%-91%)
  * Leela Zero vs Leela Zero(B5s-W3s) **8:18** (91%-86%)
  * Leela Zero vs Leela Zero(B5s-W3s) **8:31** (86%-82%)
* 整理辦公室電腦裡的電子書. **9:44**
* Don't memorize words APP check-in. **9:44**
* 163 music APP check-in. **9:45**
* NowCoder check-in. **9:46**
* Read articles and check interview invitation (MaiMai APP). **9:50**
* 101WeiQi daily exercise check-in. **9:50**, **9:52**
* Tencent cartoon APP check-in. **9:52**
* Download books from salttiger (none). **9:52**
* Read mails from skyzhx@163.com. **9:54**
* Read mails from 13417xx51@139.com. **9:55**
* Check news from ZhiHu app or website. **9:56**
* Check gitee messages. **10:01**
* Check github messages. **11:27**
* Download ebook from jb51.net. **11:29**
* Update and upgrade packages at wsl. **11:30**
* Read Sina Blog. **14:00**
* Reading mail from jedigit@163.com mail. **16:44**
* 百词斩. **16:51**
* Exercise of Vocabulary (vocabulary.com). **17:16**
