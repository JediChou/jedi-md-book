...
* Daily study
  ...
  * Check gitee messages. **8:02**
  * Check github messages. **8:03**
  * Read Sina Blog. **8:21**
  * Exercise of Vocabulary (vocabulary.com). **10:08**
  * 百词斩

* Weekly task
  * reading mail from jedigit@163.com mails. **9:57**
  * reading mails from skyzhx@163.com. **9:58**
  * Reading 1 minutes at SIMPLE wiki or Baike.Baidu
  * Go Game check
    * Leela Zero vs Leela Zero(B5s-W3s) **9:06** (64%-54%)
    * Leela Zero vs Leela Zero(B5s-W3s) **9:20** (54%-48%)
    * Leela Zero vs Leela Zero(B5s-W3s) **9:32** (48%-43%)

* Download books from salttiger. **10:09**
