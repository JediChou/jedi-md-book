...
Author: Jedi Chou, Create at 2021.5.20 7:53 AM

* Don't memorize words APP check-in. **9:14**
* Tencent cartoon APP check-in. **9:14**
* NowCoder check-in. **9:15**
* Read articles and check interview invitation (MaiMai APP). **9:16**
* 163 music APP check-in. **9:16**
* 101WeiQi daily exercise check-in. **9:17**, **9:18**
* Download books from salttiger. **9:22**
* Check gitee messages. **9:27**
* Check news from ZhiHu app or website. **9:33**
* Read mails from skyzhx@163.com. **9:37**
* Read mails from 13417xx51@139.com. **9:38**
* Read Sina Blog. **9:57**
* Download ebook from jb51.net. **9:58**
* Exercise of Vocabulary (vocabulary.com). **10:17**
* Check github messages. **10:17**
* Update and upgrade packages at wsl. **10:29**
* Reading mail from jedigit@163.com mails. **11:44**
* 百词斩. **11:48**
* Go Game check
  * Leela Zero vs Leela Zero(B5s-W3s) **8:17** (64%-59%)
  * Leela Zero vs Leela Zero(B5s-W3s) **8:34** (59%-53%)
  * Leela Zero vs Leela Zero(B5s-W3s) **8:43** (53%-49%)
  * Leela Zero vs Leela Zero(B5s-W3s) **9:59** (49%-56% charging)
  * Leela Zero vs Leela Zero(B5s-W3s) **10:10** (56%-53%)
  * Leela Zero vs Leela Zero(B5s-W3s) **10:39** (53%-55% charging)
  * Leela Zero vs Leela Zero(B5s-W3s) **12:09** (55%-47%)
  * Leela Zero vs Leela Zero(B5s-W3s) **12:29** (47%-39%)
  * Leela Zero vs Leela Zero(B5s-W3s) **12:42** (39%-34%)
* Reading 1 minutes at SIMPLE wiki or Baike.Baidu. **12:49**
* *潘建瑜-LATEX 科技排版入门(2018.11).pdf* 快速走讀一次. **13:50**
