...
Author: Jedi Chou, Create at 2021.4.28 7:57 AM
...
* Daily study
  ...
  * 百词斩. 8:27
  * Check github messages. **8:31**
  * Check gitee messages. **8:38**
  * Read Sina Blog. **8:41**
  * Exercise of Vocabulary (vocabulary.com). **9:05**

* Weekly task
  * reading mails from skyzhx@163.com. **8:36**
  * reading mail from jedigit@163.com mails. **9:53**
  * Reading 1 minutes at SIMPLE wiki or Baike.Baidu
  * Go Game check
    * Leela Zero vs Leela Zero(B5s-W3s) **8:47** (92%-87%)
    * Leela Zero vs Leela Zero(B5s-W3s) **9:10** (87%-80%)
    * Leela Zero vs Leela Zero(B5s-W3s) **9:20** (80%-76%)
