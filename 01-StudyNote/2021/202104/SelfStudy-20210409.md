...
Author: Jedi Chou, Create at 2021.4.9 14:41 PM
...
* Daily study
  ...
  * 百词斩. 7:15
  * Read Sina Blog. **14:40**
  * Check gitee messages. **14:30**
  * Quick reading Serillog getting start documents. **14:39**
  * Exercise of Vocabulary (vocabulary.com). **14:47**

* Weekly task
  * reading mail from jedigit@163.com mails. **14:05**
  * reading mails from skyzhx@163.com. **14:22**
  * Reading 1 minutes at SIMPLE wiki or Baike.Baidu
  * Go Game check
    * Leela Zero vs Leela Zero(B5s-W3s). **14:35** (100%-95%)
    * Leela Zero vs Leela Zero(B5s-W3s). **14:41** (95%-93%)
    * Leela Zero vs Leela Zero(B5s-W3s). **15:08** (92%-87%)
