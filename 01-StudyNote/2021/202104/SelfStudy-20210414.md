...
Author: Jedi Chou, Create at 2021.4.14 7:45 PM
...
* Daily study
  ...
  * 百词斩. 7:10
  * Read Sina Blog. **7:15**, **9:00**
  * Check gitee messages. **9:00**
  * Check github messages. **9:00**
  * Exercise of Vocabulary (vocabulary.com). **9:32**

* Weekly task
  * reading mails from skyzhx@163.com. **9:39**
  * reading mail from jedigit@163.com mails. **9:57**
  * Reading 1 minutes at SIMPLE wiki or Baike.Baidu
  * Go Game check
    * Leela Zero vs Leela Zero(B5s-W3s). **8:03** (60%-52%)
    * Leela Zero vs Leela Zero(B5s-W3s). **8:24** (52%-46%)
    * Leela Zero vs Leela Zero(B5s-W3s). **8:34** (46%-41%)
