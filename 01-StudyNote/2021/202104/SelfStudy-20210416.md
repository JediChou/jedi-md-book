...
Author: Jedi Chou, Create at 2021.4.16 7:55 PM
...
* Daily study
  ...
  * 百词斩. 7:15
  * Check github messages. **8:32**
  * Check gitee messages. **8:33**
  * Read Sina Blog
...
* Weekly task
  ...
  * Go Game check
    * Leela Zero vs Leela Zero(B5s-W3s). **8:08** (57%-51%)
    * Leela Zero vs Leela Zero(B5s-W3s). **8:22** (51%-47%)
    * Leela Zero vs Leela Zero(B5s-W3s). **8:31** (47%-44%)
